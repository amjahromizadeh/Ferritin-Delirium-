Not all the required tests are reported here; this markdown file logs the successful runs.
## Required regions
...
**LD panel:** 1000G Phase 3 **GRCh38** chr19 EUR; QC: MinorFreq>0 & callrate≥0.95; palindromics kept only if |EAF−0.5|>0.05. 
...
For this test, I wasn't able to use coloc.susie directly. So, I used an alternative method; I switched to a direct SuSiE×SuSiE approach in test #2.

#### What the “bypass” (SuSiE×SuSiE) method does 
...
### 5. **Ferritin (GWAS) ↔ APOE pQTL (SomaLogic prot-a-131)**
